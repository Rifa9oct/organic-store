    ...
    return (
        <div className="bg-black py-[35px] mb-[140px]">
            <div className="max-w-[1320px] mx-auto grid md:grid-cols-2 grid-cols-1 lg:grid-cols-4 gap-8">
                <div data-aos="flip-up" data-aos-duration="1200" className="flex justify-center items-center gap-4 w-[285px] h-[122px] mx-auto bg-[#333333] rounded-md">
                ...
                <div data-aos="flip-up" data-aos-duration="1200" className="flex justify-center items-center gap-4 mx-auto w-[285px] h-[122px] bg-[#333333] rounded-md" >
