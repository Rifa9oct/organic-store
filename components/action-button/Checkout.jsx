...
const Checkout = ({ userId, product }) => {
    ...
    return (
        <div>
            <button
                onClick={handleClick}
                className="hover:bg-lime-600 border border-[#8BC34A] text-[#8BC34A] hover:text-white text-sm px-4 md:text-base md:px-8 py-2 font-medium rounded uppercase flex items-center gap-2  transition">
