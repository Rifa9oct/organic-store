...
const Banner = () => {
    return (
        <div className="bg-[#F8F6F3] flex md:flex-row flex-col-reverse text-center md:text-start gap-[80px] justify-center items-center py-10 md:py-16 lg:py-[128px]">
            ...
            <div>
                ...
                <p className="lg:w-[650px] text-gray-600 mt-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
                <Link href="/shop">
